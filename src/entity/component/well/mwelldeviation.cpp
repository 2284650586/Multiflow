...
MWellDeviation::MWellDeviation(double measurePointMD, double measurePointTVD, double inclination, double azimuth, double displacementEW, double displacementNS, double dogleg, double closureHorizon, double closureAzimuth, double closureDispl) : measurePointMD(measurePointMD),
