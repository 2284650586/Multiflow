\doxysection{xlsxglobal.\+h}
\hypertarget{xlsxglobal_8h_source}{}\label{xlsxglobal_8h_source}\index{MultiflowUI/xlsx/xlsxglobal.h@{MultiflowUI/xlsx/xlsxglobal.h}}
\mbox{\hyperlink{xlsxglobal_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00025\ \textcolor{preprocessor}{\#ifndef\ XLSXGLOBAL\_H}}
\DoxyCodeLine{00026\ \textcolor{preprocessor}{\#define\ XLSXGLOBAL\_H}}
\DoxyCodeLine{00027\ \textcolor{preprocessor}{\#include\ <QtGlobal>}}
\DoxyCodeLine{00028\ }
\DoxyCodeLine{00029\ \textcolor{preprocessor}{\#define\ QT\_BEGIN\_NAMESPACE\_XLSX\ namespace\ QXlsx\ \{}}
\DoxyCodeLine{00030\ \textcolor{preprocessor}{\#define\ QT\_END\_NAMESPACE\_XLSX\ \}}}
\DoxyCodeLine{00031\ \textcolor{preprocessor}{\#define\ QTXLSX\_USE\_NAMESPACE\ using\ namespace\ QXlsx;}}
\DoxyCodeLine{00032\ }
\DoxyCodeLine{00033\ \textcolor{preprocessor}{\#if\ !defined(QT\_STATIC)\ \&\&\ !defined(XLSX\_NO\_LIB)}}
\DoxyCodeLine{00034\ \textcolor{preprocessor}{\#if\ defined(QT\_BUILD\_XLSX\_LIB)}}
\DoxyCodeLine{00035\ \textcolor{preprocessor}{\#define\ Q\_XLSX\_EXPORT\ Q\_DECL\_EXPORT}}
\DoxyCodeLine{00036\ \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{00037\ \textcolor{preprocessor}{\#define\ Q\_XLSX\_EXPORT\ Q\_DECL\_IMPORT}}
\DoxyCodeLine{00038\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00039\ \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{00040\ \textcolor{preprocessor}{\#define\ Q\_XLSX\_EXPORT}}
\DoxyCodeLine{00041\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00042\ }
\DoxyCodeLine{00043\ \textcolor{preprocessor}{\#ifdef\ XLSX\_TEST}}
\DoxyCodeLine{00044\ \textcolor{preprocessor}{\#define\ XLSX\_AUTOTEST\_EXPORT\ Q\_XLSX\_EXPORT}}
\DoxyCodeLine{00045\ \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{00046\ \textcolor{preprocessor}{\#define\ XLSX\_AUTOTEST\_EXPORT}}
\DoxyCodeLine{00047\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00048\ }
\DoxyCodeLine{00049\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{//\ XLSXGLOBAL\_H}}
