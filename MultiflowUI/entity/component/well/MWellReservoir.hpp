...
public:
    ...
    MWellReservoir(ReservoirFluidType fluidType, double fluidDensity, double fluidViscosity, double reservoirPressure,
                   double reservoirTemperature, double reservoirWatercut);
