...
public:
    ...
    MWellDeviation(double measurePointMD, double measurePointTVD, double inclination, double azimuth,
    ...
    QList<MDeviationParameter*> getParList() const;

    void addPar(MDeviationParameter* par) { parList.append(par); }
...
private:
    ...
    QList<MDeviationParameter*> parList;
};
