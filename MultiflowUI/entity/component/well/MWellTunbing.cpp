...
MWellTunbing::MWellTunbing(const QString& id, double innerDiameter, double outDiameter, const QString& materialId,
                           double specs, double perLengthWeight, double collapsePress, double maxTensile,
                           double noumenonTensile, double connectionStrength, const QString& joinType,
                           double driftDiameter, double burstPress, double maxCTorque, const QString& factory,
                           const QString& model, const QString& sn, double safeFactory, double perLengthDensity,
                           double elasticModule, const QDateTime& createDate, const QString& createUser,
                           const QDateTime& updateDate, const QString& updateUser, const QString& description,
                           const QByteArray& icon, double poissonRatio, const QString& name, double roughness,
                           double thermal, double toMD, double wallThickness, const QString& grade, double density,
                           double ID, const QString& fluid, double fluidDensity, double fluidThermalCond) : id(id),
