...
public:
    ...
    MFlowline(FlowlineType flowlineType, FlowlineMode flowlineMode, FlowlineEnviroment flowlineEnviroment,
              double pipInsideDiameter, double pipWallThickness, double pipeRoughness, double profileHorizontalDistance,
              double profileElevatiaonDifference, double heatTransferCoefficient);
    ...
    void addPar(MFlowlineParameter* par) { parList.append(par); }
    ...
    QList<MFlowlineParameter*> getParList() const;
...
private:
    ...
    QList<MFlowlineParameter*> parList;
};
