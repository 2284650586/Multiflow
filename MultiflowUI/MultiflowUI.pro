...
debug {
    MultiflowLibraryPath = $$OUT_PWD/../MultiflowLibrary/debug/
} else {
    MultiflowLibraryPath = $$OUT_PWD/../MultiflowLibrary/release/
}

message(Multiflow core library search path is: $$MultiflowLibraryPath)

LIBS += -L$$MultiflowLibraryPath -lMultiflowLibrary
